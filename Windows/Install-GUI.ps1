...
Show-Info "Allure3-Katalon Bridge installed into:`n$projectPath`n`nNext steps:`n1. Reopen (or refresh) the project in Katalon Studio.`n2. Run any Test Suite as usual.`n3. Look for '[Allure3]' lines in the console, and an allure-report folder afterwards.`n4. The report is one self-contained .html file - just double-click it, no server needed."
